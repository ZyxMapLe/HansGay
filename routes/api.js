...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('WELCOME TO ojan API!') // boleh diubah
}

var creatorList = ['ojan']; // Nama Lu Ngab
var creator = creatorList[Math.floor(Math.random() * creatorList.length)]; // Ini jan diubah
var key = 'OjanKeY' // Apikey Lu Ngab
...
router.get('/playstore', async (req, res, next) => {
    ...
    if (!namaapk) return res.json({ status : false, creator : `${creator}`, message : "Masukan parameter nama apk"})
       ...
       fetch(encodeURI(`https://api.zeks.xyz/api/sgplay?apikey=Ojannnnnnnn&q=${namaapk}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/happymod', async (req, res, next) => {
    ...
    if (!namaapk) return res.json({ status : false, creator : `${creator}`, message : "Masukan parameter nama apk"})
       ...
       fetch(encodeURI(`https://api.zeks.xyz/api/happymod?apikey=Ojannnnnnnn&q=${namaapk}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/Gsm', async (req, res, next) => {
    ...
    if (!ygdicarik) return res.json({ status : false, creator : `${creator}`, message : "Masukan parameter nama ygdicarik"})
       ...
       fetch(encodeURI(`https://api.zeks.xyz/api/gsmArena?apikey=Ojannnnnnnn&q=${ygdicarik}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/sticker', async (req, res, next) => {
    ...
    if (!nama) return res.json({ status : false, creator : `${creator}`, message : "Masukan parameter nama"})
       ...
       fetch(encodeURI(`https://api.zeks.xyz/api/searchsticker?apikey=Ojannnnnnnn&q=${nama}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/sticker/line', async (req, res, next) => {
    ...
    if (!link) return res.json({ status : false, creator : `${creator}`, message : "Masukan parameter link"})
       ...
       fetch(encodeURI(`https://api.zeks.xyz/api/linesticker?link=${link}&apikey=Ojannnnnnnn`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/sticker/telegram', async (req, res, next) => {
    ...
    if (!link) return res.json({ status : false, creator : `${creator}`, message : "Masukan parameter link"})
       ...
       fetch(encodeURI(`https://api.zeks.xyz/api/telegram-sticker?apikey=Ojannnnnnnn&url={link}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/jadwal/tv', async (req, res, next) => {
    ...
    if (!channel) return res.json({ status : false, creator : `${creator}`, message : "Masukan parameter channel"})
       ...
       fetch(encodeURI(`https://api.zeks.xyz/api/jadwaltv?channel=${channel}&apikey=Ojannnnnnnn`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/iguser', async (req, res, next) => {
    ...
    if (!nama) return res.json({ status : false, creator : `${creator}`, message : "Masukan parameter nama"})
       ...
       fetch(encodeURI(`https://api.zeks.xyz/api/iguser?apikey=Ojannnnnnnn&q=${nama}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/simsimi', async (req, res, next) => {
 ...
 try {
       var json = await (await fetch(`https://api.zeks.xyz/api/simi?apikey=Ojannnnnnnn&text=${kata}`)).json()
...
router.get('/tahta', async (req, res, next) => {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await (await fetch(`https://api.zeks.xyz/api/hartatahta?text=${text}&apikey=Ojannnnnnnn`)).buffer()
...
router.get('/customtahta', async (req, res, next) => {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await (await fetch(`https://api.zeks.xyz/api/tahta?text=${text}&apikey=Ojannnnnnnn`)).buffer()
...
try {
  ...
  if (!emoji) return res.json(loghandler.notemoji)
     ...
     var hasil = await (await fetch(`https://api.zeks.xyz/api/emoji-image?apikey=Ojannnnnnnn&emoji=${encodeURIComponent(emoji)}`)).buffer()
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var json = await (await fetch(`https://api.zeks.xyz/api/brainly?apikey=Ojannnnnnnn&q=${text}&count=5`)).json()
       res.json(json)
...
try {
  ...
  if(apikeyInput !== `${key}`) return res.sendFile(invalidKey)
     ...
     var json = await (await fetch(`https://api.zeks.xyz/api/pantun?apikey=Ojannnnnnnn`)).json()
         res.json(json)
...
try {
  ...
  if(apikeyInput !== `${key}`) return res.sendFile(invalidKey)
     ...
     var json = await (await fetch(`https://api.zeks.xyz/api/memeindo?apikey=Ojannnnnnnn`)).json()
     var hasil = await getBuffer(json.result)
...
try {
  ...
  if (!url.startsWith('http')) return res.json(loghandler.invalidLink)
     ...
     var json = await (await fetch(`https://api.zeks.xyz/api/mediafire?apikey=Ojannnnnnnn&url=${url}`)).json()
         res.json(json)
...
try {
  ...
  if(apikeyInput !== `${key}`) return res.sendFile(invalidKey)
     ...
     var json = await (await fetch(`https://api.zeks.xyz/api/darkjokes?apikey=Ojannnnnnnn`)).json()
     var hasil = await getBuffer(json.result)
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.xyz/api/splaybutton?text=${text}&apikey=Ojannnnnnnn`)
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.xyz/api/gplaybutton?text=${text}&apikey=Ojannnnnnnn`)
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.xyz/api/sandw?apikey=Ojannnnnnnn&text=${text}`)
...
try {
  ...
  if (!t2) return res.json(loghandler.nottext2)
     ...
     var json = await (await fetch(`https://api.zeks.xyz/api/snowwrite?text1=${t1}&text2=${t2}&apikey=Ojannnnnnnn`)).json()
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.xyz/api/tfire?text=${text}&apikey=Ojannnnnnnn`)
...
try {
  ...
  if (!t3) return res.json(loghandler.nottext3)
     ...
     var json = await (await fetch(`https://api.zeks.xyz/api/retro?text1=${t1}&text2=${t2}&text3=${t3}&apikey=Ojannnnnnnn`)).json()
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.xyz/api/matrix?apikey=Ojannnnnnnn&text=${text}`)
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.xyz/api/text3dbox?apikey=Ojannnnnnnn&text=${text}`)
...
try {
  ...
  if (!t2) return res.json(loghandler.nottext2)
     ...
     var hasil = await getBuffer(`https://api.zeks.xyz/api/phlogo?text1=${t1}&text2=${t2}&apikey=Ojannnnnnnn`)
...
try {
  ...
  if (!t2) return res.json(loghandler.nottext2)
     ...
     var hasil = await getBuffer(`https://api.zeks.xyz/api/marvellogo?text1=${t1}&text2=${t2}&apikey=Ojannnnnnnn`)
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.xyz/api/logobp?text=${text}&apikey=Ojannnnnnnn`)
...
try {
  ...
  if (!t2) return res.json(loghandler.nottext2)
     ...
     var hasil = await getBuffer(`https://api.zeks.xyz/api/logoaveng?text1=${t1}&text2=${t2}&apikey=Ojannnnnnnn`)
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.xyz/api/thundertext?text=${text}&apikey=Ojannnnnnnn`)
...
try {
  ...
  if (!q) return res.json(loghandler.notquery)
     ...
     var json = await (await fetch(`https://api.zeks.xyz/api/spotify?apikey=Ojannnnnnnn&q=${q}`)).json()
